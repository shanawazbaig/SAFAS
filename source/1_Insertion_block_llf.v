...
//                  All Rights Reserved
//
// Description:     LLF Hybrid Insertion Block supporting both SRJF and LLF modes
//                  MODE = 0: SRJF (Shortest Remaining Job First)
//                  MODE = 1: LLF (Least Laxity First)
// 010100101000000100011010000001010011

`timescale 1ns / 1ns
module Insertion_block_llf #(parameter W=41, N=64, MODE=0)(
	input clk, rst,
	input subtract,
	input rd,
	input wr,
...
generate
	for (o=0; o<N; o=o+1) begin : IB
		Insertion_cell_llf #(.W(W), .MODE(MODE)) Ins_cell(
		//inputs
			.clk          (clk),
			.rst          (rst),
			.subtract     (subtract),
