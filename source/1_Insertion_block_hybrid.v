...
//                  All Rights Reserved
//
// Description:     Hybrid Insertion Block supporting both SRJF and EDF modes
//                  MODE = 0: SRJF (Shortest Remaining Job First)
//                  MODE = 1: EDF (Earliest Deadline First)
// 010100101000000100011010000001010011

`timescale 1ns / 1ns
module Insertion_block_hybrid #(parameter W=41, N=64, MODE=0)(
	input clk, rst,
	input subtract,
	input rd,
	input wr,
...
generate
	for (o=0; o<N; o=o+1) begin : IB
		Insertion_cell_hybrid #(.W(W), .MODE(MODE)) Ins_cell(
		//inputs
			.clk          (clk),
			.rst          (rst),
			.subtract     (subtract),
